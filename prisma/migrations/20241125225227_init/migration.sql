...
-- CreateEnum
CREATE TYPE "TimelineEventType" AS ENUM ('DEAL_CREATED', 'STATUS_CHANGE', 'RESOURCE_ADDED', 'RESOURCE_REMOVED', 'MEMBER_ADDED', 'MEMBER_REMOVED', 'MEETING_SCHEDULED', 'MEETING_COMPLETED', 'EMAIL_SENT', 'EMAIL_RECEIVED', 'NOTE_ADDED', 'MILESTONE_REACHED', 'TASK_COMPLETED');
